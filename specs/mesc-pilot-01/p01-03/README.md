...
Repository owner / founder authorization
  -> MedScale lead authorization
    -> P01-03 planning authorization
      -> P01-03 execution authorization (separate, not granted)
...
| Document | Purpose |
|---|---|
| `research.md` | Repository inspection findings and schema-honesty audit |
| `spec.md` | Problem, objectives, scope, non-goals, invariants |
| `plan.md` | Gated future execution stages |
| `data-model.md` | Native and normalized data models |
| `execution-protocol.md` | Future acquisition, transformation, validation protocol |
| `decision-record.md` | Selected protocols and rejected alternatives |
| `acceptance.md` | Planning acceptance and execution readiness |
