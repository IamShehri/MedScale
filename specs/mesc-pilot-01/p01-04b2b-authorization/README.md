...
P01-04B2B leakage primitive library. It authorizes nothing to run and nothing to
be written yet.
...
merged head c59e4e16015a89197622227526458e9cead855fd
1 commit / 5 files / +1259 / -1

FD-B2A-9:
ADOPTED ON CANONICAL MAIN

FD-B2A-9 ADOPTED_SHA:
bfc4254b6a028ea7ec5969b505d73e7d66751272
...
The historical B2A acceptance package retains its pre-adoption language. That
state is superseded **additively** here and in the chronological task ledger; no
prior document is rewritten.
...
B2A is now accepted and canonically adopted, so the B2B prerequisite is
satisfied. **That makes a B2B authorization decision eligible. It does not
automatically authorize B2B** — this package is that separate decision, and even
it does not activate until canonically adopted.
...
| [`implementation-contract.md`](implementation-contract.md) | The exact primitive, normalization, threshold, identity, classification, boundary, error and test requirements the future implementation must satisfy |
